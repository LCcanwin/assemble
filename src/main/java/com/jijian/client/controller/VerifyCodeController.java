...
public class VerifyCodeController {
    ...
    @ResponseBody
    public ResultJson<Boolean> validatePhoneCode(@RequestParam(value = "code", required = false) String code, HttpServletRequest request){
        ...
        if (code.equals(String.valueOf(redisCode))) {
            ...
            return ResultJson.getReturnJson(500,"验证失败！验证码不正确", null);
        }
    }
}
